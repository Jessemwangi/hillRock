...
import Bgimg from '../../assets/images/backgrounds/contact-bg-1.jpg'

function ContactformTwo() {
    return (
        <>
            <section className="contact-two">
                <div className="contact-two__bg" style={{ backgroundImage:`url(${Bgimg})` }}/>
                <div className="container">
                    <div className="row"> 
                        <div className="col-lg-6">
                            <form className="contact-two__form contact-form-validated wow fadeInUp" data-wow-duration="1500ms" action="inc/sendemail.php">
